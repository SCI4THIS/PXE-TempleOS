...
the sound card so it can produce God songs.  

## Containers

The composition consists of dnsmasq, nginx, and samba containers which are driven by a .env 
file to get the IP address and UID/GID correctly.
